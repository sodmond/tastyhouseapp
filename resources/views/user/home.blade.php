                                    ...
                                    <div class="row g-sm-4 g-3">
                                        <div class="col-xxl-4 col-lg-6 col-md-4 col-sm-6">
                                            <div class="total-contain">
                                                ...
                                                <img src="{{ asset('frontend/images/svg/order.svg') }}" class="blur-up lazyload"
                                                    alt="">
                                        ...
                                        <div class="col-xxl-4 col-lg-6 col-md-4 col-sm-6">
                                            <div class="total-contain">
                                                <img src="{{ asset('frontend/images/svg/pending.svg') }}"
                                                    class="img-1 blur-up lazyload" alt="">
                                                <img src="{{ asset('frontend/images/svg/pending.svg') }}" class="blur-up lazyload"
                                                    alt="">
                                                <div class="total-detail">
                                                    <h5>Total Sales</h5>
                                                    <h3>12550</h3>
                                        ...
                                        <div class="col-xxl-4 col-lg-6 col-md-4 col-sm-6">
                                            <div class="total-contain">
                                                <img src="{{ asset('frontend/images/svg/wishlist.svg') }}"
                                                    class="img-1 blur-up lazyload" alt="">
                                                <img src="{{ asset('frontend/images/svg/wishlist.svg') }}"
