        ...
        <div class="row">
            ...
            <div class="col-custom-">
                <div class="banner-contain-2 hover-effect">
                    <img src="{{ asset('frontend/images/shop/1.jpg') }}" class="bg-img rounded-3 blur-up lazyload" alt="">
                            ...
                            <div class="product-header">
                                <div class="product-image">
                                    <a href="product-left-thumbnail.html">
                                        <img src="{{ asset('frontend/images/cake/product/2.png') }}"
                    ...
                    <div>
                        <div class="product-box-3 h-100 wow fadeInUp" data-wow-delay="0.05s">
                            <div class="product-header">
                                <div class="product-image">
                                    <a href="product-left-thumbnail.html">
                                        <img src="{{ asset('frontend/images/cake/product/3.png') }}"
                                            class="img-fluid blur-up lazyload" alt="">
                                    </a>
                    ...
                    <div>
                        <div class="product-box-3 h-100 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="product-header">
                                <div class="product-image">
                                    <a href="product-left-thumbnail.html">
                                        <img src="{{ asset('frontend/images/cake/product/4.png') }}"
                                            class="img-fluid blur-up lazyload" alt="">
                                    </a>
                    ...
                    <div>
                        <div class="product-box-3 h-100 wow fadeInUp" data-wow-delay="0.15s">
                            <div class="product-header">
                                <div class="product-image">
                                    <a href="product-left-thumbnail.html">
                                        <img src="{{ asset('frontend/images/cake/product/5.png') }}"
                                            class="img-fluid blur-up lazyload" alt="">
                                    </a>
                    ...
                    <div>
                        <div class="product-box-3 h-100 wow fadeInUp" data-wow-delay="0.2s">
                            <div class="product-header">
                                <div class="product-image">
                                    <a href="product-left-thumbnail.html">
                                        <img src="{{ asset('frontend/images/cake/product/6.png') }}"
                                            class="img-fluid blur-up lazyload" alt="">
                                    </a>
                    ...
                    <div>
                        <div class="product-box-3 h-100 wow fadeInUp" data-wow-delay="0.25s">
                            <div class="product-header">
                                <div class="product-image">
                                    <a href="product-left-thumbnail.html">
                                        <img src="{{ asset('frontend/images/cake/product/7.png') }}"
                                            class="img-fluid blur-up lazyload" alt="">
                                    </a>
