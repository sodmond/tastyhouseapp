                    ...
                    <div class="service-contain">
                        <div class="service-box">
                            <div class="service-image">
                                <img src="{{ asset('frontend/svg/product.svg') }}" class="blur-up lazyload" alt="">
                            </div>
                        ...
                        <div class="service-box">
                            <div class="service-image">
                                <img src="{{ asset('frontend/svg/delivery.svg') }}" class="blur-up lazyload" alt="">
                            </div>
                        ...
                        <div class="service-box">
                            <div class="service-image">
                                <img src="{{ asset('frontend/svg/discount.svg') }}" class="blur-up lazyload" alt="">
                            </div>
                        ...
                        <div class="service-box">
                            <div class="service-image">
                                <img src="{{ asset('frontend/svg/market.svg') }}" class="blur-up lazyload" alt="">
                            </div>
                ...
                <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6">
                    ...
                    <div class="footer-contain">
                        <ul>
                            @for($i=0; $i < 6; $i++)
                            <li>
                                <a href="#" class="text-content">{{ ucwords(strtolower($th_categories1[$i]->title)) }}</a>
                            </li>
                            @endfor
                        </ul>
                    </div>
